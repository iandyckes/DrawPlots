...
int CorrDrawPlotsFSBG()
{
  ...
  // double Ree=0.454013;  //Using targeted
  // double Rmumu=0.509199;

  double Ree=0.440974;  //using inclusive
  ...
  for(int i=0; i < size; i++)
	{
	  ...
	  h_format(v_mll_ee_inc[i]);      //no point in formatting emu, or mumu after i get rid of mumu plots...
