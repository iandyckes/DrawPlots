  ...
  if(name.Contains("zjets"))     //long because first, needs more formatting
	{
	  ...
	  if(name.Contains("mll"))
		{ 
		  ...
		  if(name.Contains("ee"))
			{
			  histo->GetXaxis()->SetTitle("m_{//} (GeV)"); 
...
int CorrDrawPlots()
{
  ...
  */
  ...
  THStack *hs_met_ee_inc = new THStack("hs_met_ee_inc","met ee+mumu inc");
  ...
  THStack *hs_met_ee_tar0 = new THStack("hs_met_ee_tar0","met ee+mumu tar0");
  ...
  THStack *hs_met_ee_tar2 = new THStack("hs_met_ee_tar2","met ee+mumu tar2");
  ...
  //-----------------------mll ee+mumu inc------------------------- -//
  //Canvas
  TCanvas *c1=new TCanvas("c1","mll ee+mumu inc ",800,800);
  ...
  v_mll_ee_inc[0]->SetTitle("Inclusive ee+mumu Dilepton mass");
  v_mll_ee_inc[0]->Draw();
  ...
  */  
  ...
  //Canvas
  TCanvas *c3=new TCanvas("c3","mll ee+mumu targeted",800,800);
  ...
  v_mll_ee_tar[0]->SetTitle("Targeted ee+mumu Dilepton mass)");
  v_mll_ee_tar[0]->Draw();
  hstar->Draw("histsame");
  ...
  */
  //---------------------MET ee+mumu INC------------------------------//
  //Canvas
  TCanvas *c5=new TCanvas("c5","Met ee+mumu inc",800,800);
  ...
  v_met_ee_inc[0]->SetTitle("ee+mumu Met (Inclusive)");
  v_met_ee_inc[0]->Draw();
  ...
  */  
  //---------------------MET ee+mumu Tar0-----------------------------//
  //Canvas
  TCanvas *c7=new TCanvas("c7","Met ee+mumu tar0",800,800);
  ...
  v_met_ee_tar0[0]->SetTitle("ee+mumu Met (no jets)");
  ...
  */  
  //---------------------MET ee+mumu Tar2------------------------------//
  //Canvas
  TCanvas *c9=new TCanvas("c9","Met ee+mumu tar2",800,800);
  ...
  v_met_ee_tar2[0]->SetTitle("ee+mumu Met (njets >=2)");
  ...
  */
  ...
  leg11->AddEntry("h_metsum_ee_tar0","ee+mumu MC","l e");
  ...
  leg12->AddEntry("h_met_ee_tar0_data","ee+mumu data","l e");
  ...
  leg13->AddEntry("h_metsum_ee_tar2","ee+mumu MC","l e");
  ...
  leg14->AddEntry("h_met_ee_tar2_data","ee+mumu data","l e");
  ...
  leg15->AddEntry("h_metsum_ee_inc","ee+mumu MC","l e");
  ...
  leg16->AddEntry("h_met_ee_inc_data","ee+mumu data","e l");
  ...
  */
  ...
  v_met_emu_inc[0]->Draw();
  hs_met_emu_inc->Draw("histsame");
 
  v_met_emu_inc[size-1]->Draw("same e1 x0");

  pad_h17->RedrawAxis();  //c1->pad_h
  ...
  leg17->AddEntry("h_met_emu_inc_data","data","ep");
  leg17->AddEntry("h_met_emu_inc_zjets","Z+jets","F");
  leg17->AddEntry("h_met_emu_inc_wz","WZ","F");
  leg17->AddEntry("h_met_emu_inc_zz","ZZ","F");
  leg17->AddEntry("h_met_emu_inc_ttbar","ttbar","F");
  leg17->AddEntry("h_met_emu_inc_singlet","single top","F");
  leg17->AddEntry("h_met_emu_inc_ww","WW","F");
  leg17->AddEntry("h_met_emu_inc_ttv","ttV","F");
  leg17->AddEntry("h_met_emu_inc_vvv","VVV","F");
  ...
  TH1F *h_met_emu_inc_data_clone = (TH1F*) v_met_emu_inc[size-1]->Clone("h_met_emu_inc_data_clone");

  //  overflow(h_metsum_emu_inc);
  
  //Divide
  h_met_emu_inc_data_clone->Divide(h_met_emu_inc_data_clone,h_metsum_emu_inc);

  h_met_emu_inc_data_clone->GetXaxis()->SetRangeUser(0,200); 
  h_met_emu_inc_data_clone->GetYaxis()->SetRangeUser(0,3);
  h_met_emu_inc_data_clone->GetYaxis()->SetNdivisions(4);
  h_met_emu_inc_data_clone->GetYaxis()->SetLabelSize(.12);
  h_met_emu_inc_data_clone->GetYaxis()->SetTitle("data/MC");

  pad_r17->SetGridy();

  h_met_emu_inc_data_clone->Draw();

  //-------------------------------------------------------------//

  //---------------------MET emu Tar0------------------------------//
  //Canvas
  TCanvas *c18=new TCanvas("c18","Met emu tar0",800,800);
  ...
  v_met_emu_tar0[0]->Draw();
  hs_met_emu_tar0->Draw("histsame");
 
  v_met_emu_tar0[size-1]->Draw("same e1 x0");

  pad_h18->RedrawAxis();  //c1->pad_h
  ...
  leg18->AddEntry("h_met_emu_tar0_data","data","ep");
  leg18->AddEntry("h_met_emu_tar0_zjets","Z+jets","F");
  leg18->AddEntry("h_met_emu_tar0_wz","WZ","F");
  leg18->AddEntry("h_met_emu_tar0_zz","ZZ","F");
  leg18->AddEntry("h_met_emu_tar0_ttbar","ttbar","F");
  leg18->AddEntry("h_met_emu_tar0_singlet","single top","F");
  leg18->AddEntry("h_met_emu_tar0_ww","WW","F");
  leg18->AddEntry("h_met_emu_tar0_ttv","ttV","F");
  leg18->AddEntry("h_met_emu_tar0_vvv","VVV","F");
  ...
  TH1F *h_met_emu_tar0_data_clone = (TH1F*) v_met_emu_tar0[size-1]->Clone("h_met_emu_tar0_data_clone");

  //  overflow(h_metsum_emu_tar0);
  
  //Divide
  h_met_emu_tar0_data_clone->Divide(h_met_emu_tar0_data_clone,h_metsum_emu_tar0);

  h_met_emu_tar0_data_clone->GetXaxis()->SetRangeUser(0,200); 
  h_met_emu_tar0_data_clone->GetYaxis()->SetRangeUser(0,3);
  h_met_emu_tar0_data_clone->GetYaxis()->SetNdivisions(4);
  h_met_emu_tar0_data_clone->GetYaxis()->SetLabelSize(.12);
  h_met_emu_tar0_data_clone->GetYaxis()->SetTitle("data/MC");

  pad_r18->SetGridy();

  h_met_emu_tar0_data_clone->Draw();

  //-------------------------------------------------------------//

  //---------------------MET emu Tar2------------------------------//
  //Canvas
  TCanvas *c19=new TCanvas("c19","Met emu tar2",800,800);
  ...
  pad_h19->SetLogy();  //c1->pad_h

  pad_h19->cd();  //change pad

  v_met_emu_tar2[0]->Draw();
  hs_met_emu_tar2->Draw("histsame");
 
  v_met_emu_tar2[size-1]->Draw("same e1 x0");

  pad_h19->RedrawAxis();  //c1->pad_h
  ...
  leg19->AddEntry("h_met_emu_tar2_data","data","ep");
  leg19->AddEntry("h_met_emu_tar2_zjets","Z+jets","F");
  leg19->AddEntry("h_met_emu_tar2_wz","WZ","F");
  leg19->AddEntry("h_met_emu_tar2_zz","ZZ","F");
  leg19->AddEntry("h_met_emu_tar2_ttbar","ttbar","F");
  leg19->AddEntry("h_met_emu_tar2_singlet","single top","F");
  leg19->AddEntry("h_met_emu_tar2_ww","WW","F");
  leg19->AddEntry("h_met_emu_tar2_ttv","ttV","F");
  leg19->AddEntry("h_met_emu_tar2_vvv","VVV","F");
  ...
  TH1F *h_met_emu_tar2_data_clone = (TH1F*) v_met_emu_tar2[size-1]->Clone("h_met_emu_tar2_data_clone");

  //  overflow(h_metsum_emu_tar2);
  
  //Divide
  h_met_emu_tar2_data_clone->Divide(h_met_emu_tar2_data_clone,h_metsum_emu_tar2);

  h_met_emu_tar2_data_clone->GetXaxis()->SetRangeUser(0,200); 
  h_met_emu_tar2_data_clone->GetYaxis()->SetRangeUser(0,3);
  h_met_emu_tar2_data_clone->GetYaxis()->SetNdivisions(4);
  h_met_emu_tar2_data_clone->GetYaxis()->SetLabelSize(.12);
  h_met_emu_tar2_data_clone->GetYaxis()->SetTitle("data/MC");
